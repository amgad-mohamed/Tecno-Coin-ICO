      ...
      >
        ...
        <div className="bg-secondBgColor rounded-2xl shadow-lg p-5 sm:p-8 border border-bgColor/60">
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 sm:px-4 sm:py-2.5 border border-bgColor/60 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent bg-fourthBgColor text-white text-sm sm:text-base"
                />
                <motion.button
                  onClick={handleAddAdmin}
                  disabled={addAdminPending || !newAdminAddress}
                  className="w-full px-3 py-2 sm:px-4 sm:py-2.5 bg-amber-500 text-white rounded-lg hover:bg-amber-600 transition-colors disabled:opacity-50 text-sm sm:text-base"
            ...
            <div className="pt-4 border-t border-bgColor/60" />
            ...
            <div className="space-y-2 max-h-48 sm:max-h-60 overflow-y-auto touch-auto">
              {adminListLoading ? (
                <div className="p-3 sm:p-4 text-center text-white/60 text-sm sm:text-base">
                ...
                adminList.map((admin, index) => (
                  <div
                    key={index}
                    className="w-full p-3 sm:p-4 bg-fourthBgColor rounded-lg text-sm sm:text-base text-white flex items-center justify-between"
                  >
            ...
            <div className="mt-6 sm:mt-8">
              ...
              <div className="space-y-3 max-h-48 sm:max-h-60 overflow-y-auto touch-auto">
                {operations.map((op, index) => (
                  ...
                  >
                    {op.status === "success" ? (
                      <FiUserPlus className="text-amber-400 flex-shrink-0" />
                    ) : (
                      <FiUserMinus className="text-white/70 flex-shrink-0" />
                    )}
